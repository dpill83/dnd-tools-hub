...
var loadInput = document.getElementById('buttonload') || document.querySelector('input[type="file"][name="button-load"]');
if (loadInput) loadInput.addEventListener('change', load_character, false);
