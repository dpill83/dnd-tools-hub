...
const SCENES = [
  ...
  // ── SCENE 3: Radiant Heart Chapterhouse ──
  {
    ...
    llmContext: (state) => `George met with Prelate Wessalen (he/him) at the Radiant Heart Chapterhouse. He ${state.tags.letter ? 'accepted the cloak and has Wessalen\'s formal backing' : 'refused the cloak and walks without institutional support'}. His narrative tag is ${state.tags.narrative}. He chose Branch ${state.choices.scene3 || 'none'}.`,
  },
